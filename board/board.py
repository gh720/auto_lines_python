...
class Board:
    ...
    def __init__(self, size=9, batch=5, colsize=None, scrub_length=5, axes=None, logfile=None, drawing_ready=None):
        if colsize==None:
        ...
        self.drawing_ready = drawing_ready
